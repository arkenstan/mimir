...
```
*(Note: You can change the target model and host URL directly within the Mimir UI via the Right Sidebar -> Settings tab).*
...
*Built with ❤️ to elevate your brainstorming sessions.*
